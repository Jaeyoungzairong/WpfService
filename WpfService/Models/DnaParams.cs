...
{
    public class DnaParams
    {
        public static DnaParams Instance { get; } = new DnaParams();
        private DnaParams() { }
        ...
        [Category("3. Check Point")]
        public int Checkpoint3 { get; set; }
        [Category("3. Check Point")]
        public int Checkpoint4 { get; set; }
        [Category("3. Check Point")]
        public int Checkpoint5 { get; set; }
        ...
        [Category("4. Correction(%)")]
        public double Correction4 { get; set; }
        [Category("4. Correction(%)")]
        public double Correction5 { get; set; }
        ...
        public bool SetData(object obj)
        {
            try
            {
                ...
                foreach (var prop in typeof(DnaParams).GetProperties(BindingFlags.Public | BindingFlags.Instance))
                {
        ...
        {
            var props = typeof(DnaParams).GetProperties(BindingFlags.Public | BindingFlags.Instance);
            var list = props
                .Select(p => new 
                {
                    Key = p.Name.ToLower(), 
